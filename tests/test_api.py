"""Tests for ConnectedRoom api."""
import asyncio

import aiohttp
from custom_components.connectedroom.api import (
    ConnectedroomApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = ConnectedroomApiClient("test", "test", async_get_clientsession(hass))
